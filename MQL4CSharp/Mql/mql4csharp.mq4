...
void ExecOnDeinit(long, int);
void ExecOnDeinitCompleted(long, int);
...
bool FileOrderPlacerConfig(long, int, string, string, string, string, double, double, bool);
#import
...
input string BeginFileOrderPlacerConfig = "#### Begin FileOrderPlacer configs ####";
input int MagicNumber = 0;
input string FileOrderPlacerFileName = "";
input string CustomSymbolMappings = "";
input string CustomLotMultipliers = "";
input string PermittedSymbols = "";
input double UseFixedLotSize = 0.0;
input double LimitOrderExpirationMinutes = 1.0;
input bool MirrorSLandTPChanges = false;
input string EndFileOrderPlacerConfig = "#### End FileOrderPlacer configs ####";
...
int OnInit()
{
   ...
   if (FileOrderPlacerFileName != "")
   {
      info("OnInit() Initializing FileOrderPlacer ", FileOrderPlacerFileName);
      bool res = FileOrderPlacerConfig(chartID, MagicNumber, FileOrderPlacerFileName, CustomSymbolMappings, CustomLotMultipliers, PermittedSymbols, UseFixedLotSize, LimitOrderExpirationMinutes, MirrorSLandTPChanges);
      if (!res)
      {
          Alert("Initializing FileOrderPlacer failed.");
          return(INIT_FAILED);
      }
   }
...
void OnDeinit(const int reason)
{
   ...
   info("OnDeinit() ExecOnDeinit: ", chartID, ", ", CSharpFullTypeName);
   // Call the DLL onDeinit
   ExecOnDeinit(chartID, reason);
   ...
   ExecOnDeinitCompleted(chartID, reason);
}
...
int CONVERT_ENUM_SYMBOL_INFO_DOUBLE(string value)
{
  if (value == "SYMBOL_BID" || value == "1") { return SYMBOL_BID; }
  if (value == "SYMBOL_BIDHIGH" || value == "2") { return SYMBOL_BIDHIGH; }
  if (value == "SYMBOL_BIDLOW" || value == "3") { return SYMBOL_BIDLOW; }
  if (value == "SYMBOL_ASK" || value == "4") { return SYMBOL_ASK; }
  if (value == "SYMBOL_ASKHIGH" || value == "5") { return SYMBOL_ASKHIGH; }
  if (value == "SYMBOL_ASKLOW" || value == "6") { return SYMBOL_ASKLOW; }
  if (value == "SYMBOL_LAST" || value == "7") { return SYMBOL_LAST; }
  if (value == "SYMBOL_LASTHIGH" || value == "8") { return SYMBOL_LASTHIGH; }
  if (value == "SYMBOL_LASTLOW" || value == "9") { return SYMBOL_LASTLOW; }
  if (value == "SYMBOL_POINT" || value == "10") { return SYMBOL_POINT; }
  if (value == "SYMBOL_TRADE_TICK_VALUE" || value == "11") { return SYMBOL_TRADE_TICK_VALUE; }
  if (value == "SYMBOL_TRADE_TICK_VALUE_PROFIT" || value == "12") { return SYMBOL_TRADE_TICK_VALUE_PROFIT; }
  if (value == "SYMBOL_TRADE_TICK_VALUE_LOSS" || value == "13") { return SYMBOL_TRADE_TICK_VALUE_LOSS; }
  if (value == "SYMBOL_TRADE_TICK_SIZE" || value == "14") { return SYMBOL_TRADE_TICK_SIZE; }
  if (value == "SYMBOL_TRADE_CONTRACT_SIZE" || value == "15") { return SYMBOL_TRADE_CONTRACT_SIZE; }
  if (value == "SYMBOL_VOLUME_MIN" || value == "16") { return SYMBOL_VOLUME_MIN; }
  if (value == "SYMBOL_VOLUME_MAX" || value == "17") { return SYMBOL_VOLUME_MAX; }
  if (value == "SYMBOL_VOLUME_STEP" || value == "18") { return SYMBOL_VOLUME_STEP; }
  if (value == "SYMBOL_VOLUME_LIMIT" || value == "19") { return SYMBOL_VOLUME_LIMIT; }
  if (value == "SYMBOL_SWAP_LONG" || value == "20") { return SYMBOL_SWAP_LONG; }
  if (value == "SYMBOL_SWAP_SHORT" || value == "21") { return SYMBOL_SWAP_SHORT; }
  if (value == "SYMBOL_MARGIN_INITIAL" || value == "22") { return SYMBOL_MARGIN_INITIAL; }
  if (value == "SYMBOL_MARGIN_MAINTENANCE" || value == "23") { return SYMBOL_MARGIN_MAINTENANCE; }
  if (value == "SYMBOL_MARGIN_LONG" || value == "24") { return SYMBOL_MARGIN_LONG; }
  if (value == "SYMBOL_MARGIN_SHORT" || value == "25") { return SYMBOL_MARGIN_SHORT; }
  if (value == "SYMBOL_MARGIN_LIMIT" || value == "26") { return SYMBOL_MARGIN_LIMIT; }
  if (value == "SYMBOL_MARGIN_STOP" || value == "27") { return SYMBOL_MARGIN_STOP; }
  if (value == "SYMBOL_MARGIN_STOPLIMIT" || value == "28") { return SYMBOL_MARGIN_STOPLIMIT; }
  if (value == "SYMBOL_SESSION_VOLUME" || value == "29") { return SYMBOL_SESSION_VOLUME; }
  if (value == "SYMBOL_SESSION_TURNOVER" || value == "30") { return SYMBOL_SESSION_TURNOVER; }
  if (value == "SYMBOL_SESSION_INTEREST" || value == "31") { return SYMBOL_SESSION_INTEREST; }
  if (value == "SYMBOL_SESSION_BUY_ORDERS_VOLUME" || value == "32") { return SYMBOL_SESSION_BUY_ORDERS_VOLUME; }
  if (value == "SYMBOL_SESSION_SELL_ORDERS_VOLUME" || value == "33") { return SYMBOL_SESSION_SELL_ORDERS_VOLUME; }
  if (value == "SYMBOL_SESSION_OPEN" || value == "34") { return SYMBOL_SESSION_OPEN; }
  if (value == "SYMBOL_SESSION_CLOSE" || value == "35") { return SYMBOL_SESSION_CLOSE; }
  if (value == "SYMBOL_SESSION_AW" || value == "36") { return SYMBOL_SESSION_AW; }
  if (value == "SYMBOL_SESSION_PRICE_SETTLEMENT" || value == "37") { return SYMBOL_SESSION_PRICE_SETTLEMENT; }
  if (value == "SYMBOL_SESSION_PRICE_LIMIT_MIN" || value == "38") { return SYMBOL_SESSION_PRICE_LIMIT_MIN; }
  if (value == "SYMBOL_SESSION_PRICE_LIMIT_MAX" || value == "39") { return SYMBOL_SESSION_PRICE_LIMIT_MAX; }
  return -1;
}

int CONVERT_ENUM_SYMBOL_INFO_INTEGER(string value)
{
  if (value == "SYMBOL_SELECT" || value == "1") { return SYMBOL_SELECT; }
  if (value == "SYMBOL_VISIBLE" || value == "2") { return SYMBOL_VISIBLE; }
  if (value == "SYMBOL_SESSION_DEALS" || value == "3") { return SYMBOL_SESSION_DEALS; }
  if (value == "SYMBOL_SESSION_BUY_ORDERS" || value == "4") { return SYMBOL_SESSION_BUY_ORDERS; }
  if (value == "SYMBOL_SESSION_SELL_ORDERS" || value == "5") { return SYMBOL_SESSION_SELL_ORDERS; }
  if (value == "SYMBOL_VOLUME" || value == "6") { return SYMBOL_VOLUME; }
  if (value == "SYMBOL_VOLUMEHIGH" || value == "7") { return SYMBOL_VOLUMEHIGH; }
  if (value == "SYMBOL_VOLUMELOW" || value == "8") { return SYMBOL_VOLUMELOW; }
  if (value == "SYMBOL_TIME" || value == "9") { return SYMBOL_TIME; }
  if (value == "SYMBOL_DIGITS" || value == "10") { return SYMBOL_DIGITS; }
  if (value == "SYMBOL_SPREAD_FLOAT" || value == "11") { return SYMBOL_SPREAD_FLOAT; }
  if (value == "SYMBOL_SPREAD" || value == "12") { return SYMBOL_SPREAD; }
  if (value == "SYMBOL_TRADE_CALC_MODE" || value == "13") { return SYMBOL_TRADE_CALC_MODE; }
  if (value == "SYMBOL_TRADE_MODE" || value == "14") { return SYMBOL_TRADE_MODE; }
  if (value == "SYMBOL_START_TIME" || value == "15") { return SYMBOL_START_TIME; }
  if (value == "SYMBOL_EXPIRATION_TIME" || value == "16") { return SYMBOL_EXPIRATION_TIME; }
  if (value == "SYMBOL_TRADE_STOPS_LEVEL" || value == "17") { return SYMBOL_TRADE_STOPS_LEVEL; }
  if (value == "SYMBOL_TRADE_FREEZE_LEVEL" || value == "18") { return SYMBOL_TRADE_FREEZE_LEVEL; }
  if (value == "SYMBOL_TRADE_EXEMODE" || value == "19") { return SYMBOL_TRADE_EXEMODE; }
  if (value == "SYMBOL_SWAP_MODE" || value == "20") { return SYMBOL_SWAP_MODE; }
  if (value == "SYMBOL_SWAP_ROLLOVER3DAYS" || value == "21") { return SYMBOL_SWAP_ROLLOVER3DAYS; }
  if (value == "SYMBOL_EXPIRATION_MODE" || value == "22") { return SYMBOL_EXPIRATION_MODE; }
  if (value == "SYMBOL_FILLING_MODE" || value == "23") { return SYMBOL_FILLING_MODE; }
  if (value == "SYMBOL_ORDER_MODE" || value == "24") { return SYMBOL_ORDER_MODE; }
  return -1;
}

int CONVERT_ENUM_SYMBOL_INFO_STRING(string value)
{
  if (value == "SYMBOL_CURRENCY_BASE" || value == "1") { return SYMBOL_CURRENCY_BASE; }
  if (value == "SYMBOL_CURRENCY_PROFIT" || value == "2") { return SYMBOL_CURRENCY_PROFIT; }
  if (value == "SYMBOL_CURRENCY_MARGIN" || value == "3") { return SYMBOL_CURRENCY_MARGIN; }
  if (value == "SYMBOL_DESCRIPTION" || value == "4") { return SYMBOL_DESCRIPTION; }
  if (value == "SYMBOL_PATH" || value == "5") { return SYMBOL_PATH; }
  return -1;
}
...
double executeDoubleCommand(int id, string params[])
{
   switch(id)
   {
      ...
      case 242:
         return SymbolInfoDouble(params[0], CONVERT_ENUM_SYMBOL_INFO_DOUBLE(params[1]));
   }
}
...
int executeIntCommand(int id, string params[])
{
   switch(id)
   {
      ...
      case 243:
         return SymbolInfoInteger(params[0], CONVERT_ENUM_SYMBOL_INFO_INTEGER(params[1]));
   }
}
...
string executeStringCommand(int id, string params[])
{
   switch(id)
   {
      ...
      case 244:
         return SymbolInfoString(params[0], CONVERT_ENUM_SYMBOL_INFO_STRING(params[1]));
   }
}
